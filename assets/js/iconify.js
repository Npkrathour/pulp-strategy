...
var Iconify = (function () {
  ...
  var n = e(function (e, n) {
    ...
    r = e(function (e, n) {
      Object.defineProperty(n, "__esModule", { value: !0 }), (n.mergeIcons = void 0);
    ...
    o = e(function (e, o) {
      Object.defineProperty(o, "__esModule", { value: !0 }), (o.parseIconSet = void 0);
      ...
      o.parseIconSet = function (e, r, o) {
        ...
        if (
          (Object.keys(f).forEach(function (e) {
            var o = f[e];
            "string" == typeof o.body && (r(e, Object.freeze(n.merge(t.iconDefaults, u, o))), c.push(e));
          }),
          ...
          Object.keys(l).forEach(function (e) {
            var o = a(l[e], f, l, 1);
            o && (r(e, Object.freeze(n.merge(t.iconDefaults, u, o))), c.push(e));
          });
        }
    ...
    i = e(function (e, n) {
      Object.defineProperty(n, "__esModule", { value: !0 }), (n.validateIcon = n.stringToIcon = void 0);
      var t = /^[a-z0-9]+(-[a-z0-9]+)*$/;
    ...
    a = e(function (e, n) {
      ...
      (n.newStorage = i),
        ...
        (n.addIcon = function (e, n, r) {
          try {
            if ("string" == typeof r.body) return (e.icons[n] = Object.freeze(t.fullIcon(r))), !0;
          } catch (e) {}
          return !1;
        }),
        ...
        (n.listIcons = function (e, n) {
          ...
          return (
            ("string" == typeof e ? [e] : Object.keys(r)).forEach(function (e) {
              ("string" == typeof e && "string" == typeof n ? [n] : void 0 === r[e] ? [] : Object.keys(r[e])).forEach(
                function (n) {
                  var r = a(e, n),
    ...
    c = e(function (e, t) {
      ...
      function f(e, n) {
        ...
        if ("string" != typeof e.prefix || !i.validateIcon({ provider: n, prefix: e.prefix, name: "a" })) return !1;
    ...
    l = e(function (e, n) {
      Object.defineProperty(n, "__esModule", { value: !0 }),
        ...
        (n.builderFunctions = { replaceIDs: u.replaceIDs, calculateSize: f.calculateSize });
    }),
    s = e(function (e, n) {
    ...
    p = e(function (e, n) {
      Object.defineProperty(n, "__esModule", { value: !0 }),
        ...
        (n.defaultConfig = { resources: [], index: 0, timeout: 2e3, rotate: 750, random: !1, dataAfterTimeout: !1 });
    }),
    h = e(function (e, n) {
      Object.defineProperty(n, "__esModule", { value: !0 }),
        (n.sendQuery = void 0),
    ...
    g = e(function (e, n) {
      function t(e) {
        ...
        for (n in p.defaultConfig) void 0 !== e[n] ? (t[n] = e[n]) : (t[n] = p.defaultConfig[n]);
        return t;
      }
      Object.defineProperty(n, "__esModule", { value: !0 }),
          ...
          return (
            e.forEach(function (e) {
              if (r.name !== e.name || r.prefix !== e.prefix || r.provider !== e.provider) {
                ...
                (void 0 !== f.icons[c] ? n.loaded : "" === i || void 0 !== f.missing[c] ? n.missing : n.pending).push(
                  l,
                );
              }
            }),
    ...
    m = e(function (e, n) {
      ...
      n.updateCallbacks = function (e, o) {
        ...
        i[o] ||
          ((i[o] = !0),
          setTimeout(function () {
            if (((i[o] = !1), void 0 !== n.callbacks[e] && void 0 !== n.callbacks[e][o])) {
    ...
    I = e(function (e, n) {
      ...
      for (
        var r = Object.create(null), o = ["https://api.simplesvg.com", "https://api.unisvg.com"], i = [];
        o.length > 0;
        ...
        (n.listToIcons = function (e, n, t) {
          ...
          return (
            e.forEach(function (e) {
              ...
              (n && !i.validateIcon(o, t)) || r.push({ provider: o.provider, prefix: o.prefix, name: o.name });
            }),
            r
          );
        }),
    ...
    x = e(function (e, n) {
      ...
      n.API = {
        isPending: function (e) {
          return (
            void 0 !== r[e.provider] && void 0 !== r[e.provider][e.prefix] && void 0 !== r[e.provider][e.prefix][e.name]
          );
        },
    ...
    O = e(function (e, n) {
      Object.defineProperty(n, "__esModule", { value: !0 }),
        ...
        (n.APIFunctions = { loadIcons: x.API.loadIcons, addAPIProvider: I.setAPIConfig }),
                ...
                if (u.maxURL) {
                  ...
                  u.resources.forEach(function (e) {
                    ...
                    (c =
                      ...
                      f -
                      u.path.length -
                      r.replace("{provider}", n).replace("{prefix}", t).replace("{icons}", "").length -
                      3);
                } else c = 0;
                var l = n + ":" + t;
                ...
                if (c.maxURL) {
                  ...
                  c.resources.forEach(function (e) {
                    ...
                    (a =
                      ...
                      u -
                      c.path.length -
                      t.replace("{provider}", n).replace("{prefix}", i).replace("{icons}", "").length);
                } else a = 0;
                var f = n + ":" + i;
        ...
        (n.iconToSVG = function (e, n) {
          ...
          switch (
            (u
              ? l
                ? (s += 2)
                : (c.push("translate(" + (a.width + a.left) + " " + (0 - a.top) + ")"),
                  c.push("scale(-1 1)"),
                  (a.top = a.left = 0))
              : l &&
                (c.push("translate(" + (0 - a.left) + " " + (a.height + a.top) + ")"),
                c.push("scale(1 -1)"),
                (a.top = a.left = 0)),
            (s %= 4))
          ) {
            case 1:
              (r = a.height / 2 + a.top), c.unshift("rotate(90 " + r + " " + r + ")");
              break;
            case 2:
              c.unshift("rotate(180 " + (a.width / 2 + a.left) + " " + (a.height / 2 + a.top) + ")");
              break;
            case 3:
              (r = a.width / 2 + a.left), c.unshift("rotate(-90 " + r + " " + r + ")");
          }
          s % 2 == 1 &&
            ((0 === a.left && 0 === a.top) || ((r = a.left), (a.left = a.top), (a.top = r)),
            a.width !== a.height && ((r = a.width), (a.width = a.height), (a.height = r))),
  ...
  function E(e, n, t, r) {
    ...
    return a && a.parentNode ? a.parentNode.replaceChild(v, a) : o.removeChild(v), P;
  }
  var C = [];
  function k(e) {
  ...
  function F(e, n) {
    void 0 === n && (n = !1);
    var t = k(e);
    return t ? (t.temporary && (t.temporary = n), t) : ((t = { node: e, temporary: n }), C.push(t), t);
  }
  function T() {
    return C;
  }
    ...
    if (e.observer) {
      ...
      if (!t.pendingScan)
        for (var r = 0; r < n.length; r++) {
          var o = n[r];
          if ((o.addedNodes && o.addedNodes.length > 0) || ("attributes" === o.type && void 0 !== o.target[S]))
  ...
  var Y = [];
  function $(e) {
    return "string" == typeof e && (e = i.stringToIcon(e)), null !== e && i.validateIcon(e) ? e : null;
  }
  function K(e) {
    var n = [];
      ...
      ((e ? [e] : T()).forEach(function (e) {
        ...
        if (r && r.querySelectorAll) {
          ...
          K(r).forEach(function (n) {
            ...
            if (
              void 0 !== p &&
              ((r = p.name), (c = f), null !== r && null !== c && r.name === c.name && r.prefix === c.prefix)
            )
              switch (p.status) {
                case "missing":
                  return;
                case "loading":
                  if (s.coreModules.api && s.coreModules.api.isPending({ provider: l, prefix: d, name: v }))
                    return void (o = !0);
              }
            var h = a.getStorage(l, d);
            if (void 0 === h.icons[v]) {
              if (h.missing[v]) return (p = { name: f, status: "missing", customisations: {} }), void (u[_] = p);
              if (s.coreModules.api && !s.coreModules.api.isPending({ provider: l, prefix: d, name: v })) {
                void 0 === t[l] && (t[l] = Object.create(null));
                var g = t[l];
                void 0 === g[d] && (g[d] = Object.create(null)), (g[d][v] = !0);
              }
              (p = { name: f, status: "loading", customisations: {} }), (u[_] = p), (o = !0);
            } else {
            ...
            e.temporary && !o ? J(r) : n && o ? H(r, !0) : i && e.observer && Q(e);
        }
      }),
      s.coreModules.api)
    ) {
  ...
  var oe = ["inline", "hFlip", "vFlip"],
    ...
    ce = {
      ...
      customisations: function (e, n) {
        ...
        if ((-1 !== (r ? r.split(/\s+/) : []).indexOf(ae) && (t.inline = !0), te(e, "data-rotate"))) {
  ...
  function ue(e, n, t) {
    ...
    return r ? E({ name: i.stringToIcon(e) }, w.fullCustomisations(n), r, t) : null;
  }
  var fe = {
    getVersion: function () {
      return "2.0.0";
  ...
  [c.storageFunctions, l.builderFunctions, fe, ve, O.APIFunctions].forEach(function (e) {
  ...
  try {
    "undefined" != typeof document &&
      ...
      (he = "function" == typeof fetch && "function" == typeof Promise ? M.getAPIModule : P.getAPIModule);
  } catch (de) {}
  if (
    (y.setAPIModule("", he(I.getAPIConfig)),
    (pe._api.setFetch = function (e) {
      M.setFetch(e), he !== M.getAPIModule && ((he = M.getAPIModule), y.setAPIModule("", he(I.getAPIConfig)));
    }),
    ...
    if (void 0 !== ge.IconifyProviders) {
      ...
      if ("object" == typeof be && null !== be)
        for (var me in be) {
          ...
          try {
            var Ie = be[me];
            if ("object" != typeof Ie || !Ie || void 0 === Ie.resources) continue;
